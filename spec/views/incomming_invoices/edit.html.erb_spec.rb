...
RSpec.describe "incomming_invoices/edit.html.erb", type: :view do
  ...
  it "edits Incomming invoice with id: as parameter" do

    controller.extra_params = { :id => @incomming_invoice.id }
    expect(controller.request.fullpath).to eq edit_incomming_invoice_path(@incomming_invoice)
  end  
end
