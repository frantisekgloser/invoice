...
RSpec.describe "outgoing_invoices/new.html.erb", type: :view do
  ...
  it "builds new Outgoing invoice" do

    expect(controller.request.fullpath).to eq new_outgoing_invoice_path
  end  
end
